...
export default function CheckinAvailableList({ standalone, disponibles, roomsLoading, onSelectRoom, onBack }) {
  return (
    <PantallaForm standalone={standalone} titulo="Registro Nuevo" desc="Selecciona una habitacion disponible" onVolver={onBack}>
