            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-gray-600">Email / Usuario</th>
                  <th className="text-left px-4 py-3 font-semibold text-gray-600">Direccion IP</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {[1,2,3,4,5].map(i => (
                  <tr key={i}>
                    <td className="px-4 py-3"><div className="h-4 w-8 animate-pulse bg-gray-200 rounded" /></td>
                    <td className="px-4 py-3"><div className="h-4 w-40 animate-pulse bg-gray-200 rounded" /></td>
                    <td className="px-4 py-3"><div className="h-4 w-48 animate-pulse bg-gray-200 rounded" /></td>
                    <td className="px-4 py-3"><div className="h-4 w-32 animate-pulse bg-gray-200 rounded" /></td>
