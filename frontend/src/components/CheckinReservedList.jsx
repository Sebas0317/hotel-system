import { AlertTriangle, User, Bed, Users } from 'lucide-react';
import PantallaForm from './PantallaForm';

export default function CheckinReservedList({ standalone, reservadas, roomsLoading, onSelectRoom, onBack }) {
  return (
    <PantallaForm standalone={standalone} titulo="Check-in con Reserva" desc="Selecciona la habitación reservada" onVolver={onBack}>
