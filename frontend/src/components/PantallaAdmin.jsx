            ...
            <>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-md p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{COP(totalRevenue)}</p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-md p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-blue-100 text-sm">Ocupación</p>
                      <p className="text-2xl font-bold">{accData.summary.occupancyRate}%</p>
                    </div>
                    <span className="text-3xl">📊</span>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-md p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-yellow-100 text-sm">Tarifa Promedio</p>
                      <p className="text-2xl font-bold">{COP(accData.summary.avgDailyRate)}</p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-md p-4 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-purple-100 text-sm">Estadías</p>
                      <p className="text-2xl font-bold">{accData.completedStays || 0}</p>
                    </div>
                    <span className="text-3xl">🏨</span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                  ...
                  <p className="text-xs text-gray-400">Habitaciones ocupadas</p>
                </div>
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                  <p className="text-sm text-gray-500"> ingreso por Servicio</p>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                  ...
                  <p className="text-xs text-gray-400">Capacidad del hotel</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                {statusData.length > 0 && (
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">🏠 Distribución de Habitaciones</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">💰 Revenue por Tipo de Habitación</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">📊 Resumen de Habitaciones</h3>
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                  {[
                    ...
                    { label: 'Avg Tarifa/Día', value: COP(accData.summary.avgDailyRate), bg: 'bg-purple-100', color: 'text-purple-700', icon: '💵' },
                  ].map((item, i) => (
