...
import { PRODUCTOS, ESTADO_CFG, METODOS_PAGO, CATEGORIAS_CONSUMO } from '../constants/index'
...
describe('ESTADO_CFG', () => {
  it('has all required states', () => {
    const states = ['disponible', 'reservada', 'ocupada', 'limpieza', 'mantenimiento', 'fuera_servicio']
    states.forEach(s => {
