...
import { COP, FECHA, calcularTotal, agruparPorPiso, filtrarRooms } from '../utils/helpers'
...
describe('filtrarRooms', () => {
  const rooms = [
    { id: '1', numero: '101', tipo: 'Suite', estado: 'disponible', huesped: '' },
    { id: '2', numero: '102', tipo: 'Suite', estado: 'ocupada', huesped: 'Juan' },
    { id: '3', numero: '201', tipo: 'Doble', estado: 'disponible', huesped: '' },
  ]
